...
class PredictionModel(DenoisePretrainModel):
    def __init__(self, model_type, hidden_size, n_channel,
                 ...
                 n_layers=3, n_residue_layers=2, dropout=0.1, std=10, atom_level=False,
                 hierarchical=False, no_block_embedding=False,
                 gate_type='scalar', fps_ratio=0.5, pool_k=9) -> None:
        super().__init__(
            model_type, hidden_size, n_channel, n_rbf, cutoff, n_head, radial_size, edge_size,
            k_neighbors, n_layers, n_residue_layers=n_residue_layers,
            dropout=dropout, std=std, atom_level=atom_level,
            hierarchical=hierarchical, no_block_embedding=no_block_embedding,
            gate_type=gate_type, fps_ratio=fps_ratio, pool_k=pool_k)
