...
class SchNetUNetEncoderV12(nn.Module):
    """
    UNet-style encoder combining:
      - SchNetGeoAttn backbone (geometry-aware attention messages) for both
        encoder and decoder interaction blocks
      - Gated skip connections from V11:
    ...
    def __init__(self, hidden_size, edge_size, n_layers=6,
        ...
        # Encoder backbone — SchNetGeoAttn replaces SchNet
        ...
        # Decoder interaction blocks — GeoAttnInteractionBlock for consistency
