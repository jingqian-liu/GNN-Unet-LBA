...
def parse():
    ...
    # model
    parser.add_argument('--model_type', type=str, required=True, choices=['GET', 'GETPool', 'SchNet', 'SchNetGeoAttn', 'SchNetGeoAttnV2', 'SchNetGeoAttnV3', 'SchNetGeoAttnV4', 'SchNetGeoAttnV5', 'SchNetUNet', 'SchNetUNetV10', 'SchNetUNetV11', 'SchNetUNetV12', 'SchNetUNetV13', 'SchNetUNetV14', 'SchNetUNetV15', 'SchNetUNetV16', 'SchNetUNetV17', 'SchNetUNetV18', 'SchNetUNetV19', 'SchNetUNetV20', 'SchNetUNetV21', 'SchNetUNetV22Semantic', 'SchNetUNetV23', 'SchNetUNetV24', 'SchNetUNetV2', 'SchNetUNetV3', 'SchNetUNetV4', 'SchNetUNetV5', 'SchNetUNetV6', 'SchNetUNetV7', 'SchNetUNetV8', 'SchNetUNetV9', 'EGNN', 'DimeNet', 'TorchMD', 'Equiformer', 'GemNet', 'MACE', 'LEFTNet'], help='type of model to use')
    ...
    parser.add_argument('--n_residue_layers', type=int, default=2, help='Number of interaction layers at residue level (SchNetUNetV8)')
    parser.add_argument('--gate_type', type=str, default='scalar', choices=['scalar', 'channel'], help='Gate type for gated skip connection (SchNetUNetV11)')
    parser.add_argument('--fps_ratio', type=float, default=0.5, help='FPS downsampling ratio (SchNetUNet models)')
    parser.add_argument('--pool_k', type=int, default=9, help='k in kNN for attention pooling aggregation (SchNetUNet models)')
